...
To understand what kinds of functions you can use on the particles in these collections, look at the `COLLECTION TYPE` and look up its functions [https://ilcsoft.desy.de/LCIO/current/doc/doxygen_api/html/namespaceEVENT.html](here).
